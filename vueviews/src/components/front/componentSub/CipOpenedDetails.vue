  ...
  <div>
    <el-row id="breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item :to="{ name: 'CipsOpened' }">浏览开放组件</el-breadcrumb-item>
    ...
    <el-row id="main_range">
      ...
      <br>
        ...
        <el-col :span="1" :offset="19">
            <el-button type="primary" icon="el-icon-shopping-cart-2" style="font-size: medium;" @click="addCart">加入购物车</el-button>
        </el-col>
  ...
  methods: {
    async getDetails() {
      ...
      if (res.code === 0) {
        ...
        await this.$router.push({name: 'AuthorizationQuery'});
      } else {
        this.projectInfo = res.data; // 接收对象参数并赋值projectInfo对象
